...
\newacronym{SKU}{SKU}{\emph{stock keeping unit}, referencia de producto que el inventario administra por separado}
\newacronym{WMS}{WMS}{\emph{warehouse management system}, sistema de gestión del depósito}
\newacronym{COI}{COI}{\emph{cube-per-order index}, espacio que necesita una SKU dividido por las veces que se la pide}
