...
En el Capítulo~\ref{chapter:antecedentes} se presentan \completar{los fundamentos y el estado del arte sobre los que se apoya la tesis}.
...
Los Capítulos~\ref{chapter:} y~\ref{chapter:} documentan el desarrollo de [NUEVA\_VERSION].
Abordan [ASPECTO\_TECNICO\_1] y [ASPECTO\_TECNICO\_2], respectivamente.
